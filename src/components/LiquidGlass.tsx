...
const LiquidGlass: React.FC<LiquidGlassProps> = ({ 
  ...
  useEffect(() => {
    ...
    class Shader {
      width: number;
      height: number;
      fragment: (uv: { x: number; y: number }, mouse: { x: number; y: number }) => any;
      canvasDPI: number;
      id: string;
      offset: number;
      ...
      constructor(options: {
        ...
        // Use provided elements or create new ones
        this.container = options.container || document.createElement('div');
        this.svg = options.svg || document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    ...
    if (containerRef.current && svgRef.current && canvasRef.current) {
      ...
      // Append SVG to body for global filters
